...
/**
 * AbstractOutinrec entity provides the base persistence definition of the
 * Outinrec entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractOutInRec implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractOutInRec() {
	}

	/** minimal constructor */
	public AbstractOutInRec(Consumable consumable, User user, Date date,
	...
	/** full constructor */
	public AbstractOutInRec(Instru instru, Consumable consumable, User user,
			Date date, Integer quantity, String action) {
		this.instru = instru;
		this.consumable = consumable;
		this.user = user;
		this.date = date;
